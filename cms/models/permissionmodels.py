...
from cms.models import ACCESS_CHOICES, ACCESS_PAGE_AND_DESCENDANTS
...
class AbstractPagePermission(models.Model):
    ...
    can_view = models.BooleanField(_("restrict to"), default=False, help_text=_("frontend view restriction"))
